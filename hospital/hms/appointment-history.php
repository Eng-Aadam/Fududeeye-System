...
{ ?>
	...
	<?php } else {
		...
		echo "Canceled";
											...
											<?php if (isset($row['payment_status']) && $row['payment_status'] == 'Approved') { ?>
												<a href="app.php?id=<?php echo $row['id']?>" class="btn btn-transparent btn-xs tooltips" title="Appointment Receipt" tooltip-placement="top" tooltip="Receipt">Receipt</a>
											<?php } ?>
												</div>
