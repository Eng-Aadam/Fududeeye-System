...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		appSetting.theme = (appSetting.theme === 'theme-6') ? 'theme-6' : 'theme-1';
		...
		if ($('#dark-mode').length) {
			$('#dark-mode').prop('checked', appSetting.theme === 'theme-6');
			$('#dark-mode').change(function() {
				var selectedTheme = $(this).is(":checked") ? 'theme-6' : 'theme-1';
